...
SELECT FIRST_NAME, TO_CHAR(SALARY*1300, 'L999,999,999') FROM EMPLOYEES; --지역화페
SELECT FIRST_NAME, TO_CHAR(SALARY*1300, 'L0999,999,999') FROM EMPLOYEES; --남은 자리수를 0으로 채움
